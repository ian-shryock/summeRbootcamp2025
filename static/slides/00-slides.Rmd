...
# Hello `r emoji::emoji("wave")`

###  Welcome to the 8th annual UO R Bootcamp!
...
```{r echo = FALSE, out.width="100%"}
knitr::include_graphics("images/sop.png")
```
...
```{r echo = FALSE, out.width="100%"}
knitr::include_graphics("images/neha.png")
```
...
---
# Schedule `r emoji::emoji("calendar")`


#### **Day 1: Wednesday, 9/24, 9 AM - 12 PM PDT**
.smaller-font[
...
#### **Day 2: Thursday, 9/25, 9 AM - 12 PM PDT**
.smaller-font[
+ Piping
...
#### **Day 3: Friday, 9/26, 9 AM - 1 PM PDT**
...
.column[.content[.center[
<br><br><br><br><br>
# [`r fontawesome::fa("github", height = "120px")`](https://github.com/ian-shryock/summeRbootcamp2025)
...
## R is fun `r emoji::emoji("partying_face")`
...
# Can't an LLM do this for me? `r emoji::emoji('robot')`

.pull-left[
### Learning `r emoji::emoji('books')`
]

.pull-right[
### Executing `r emoji::emoji('rocket')`
]

.pull-center[
- What is an LLM doing for you right now?
- What could you be missing out on by **using** it?
